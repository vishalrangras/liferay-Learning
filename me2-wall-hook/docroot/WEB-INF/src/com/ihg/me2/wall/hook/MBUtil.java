...
public class MBUtil {
	...
	public static String getEmailFromName(
		...
		return PortalUtil.getEmailFromName(
			preferences, companyId, PropsUtil.get(PropsKeys.MESSAGE_BOARDS_EMAIL_FROM_NAME));
	}
	...
	public static String getEmailMessageAddedSubject(
		...
		if (Validator.isNotNull(emailMessageAddedSubject)) {
			...
			return ContentUtil.get(
					PropsUtil.get(PropsKeys.MESSAGE_BOARDS_EMAIL_MESSAGE_ADDED_SUBJECT));
		}
	}
	...
	public static String getEmailMessageUpdatedSubject(
		...
		if (Validator.isNotNull(emailMessageUpdatedSubject)) {
			...
			return ContentUtil.get(
					PropsUtil.get(PropsKeys.MESSAGE_BOARDS_EMAIL_MESSAGE_UPDATED_SUBJECT));
		}
	}
