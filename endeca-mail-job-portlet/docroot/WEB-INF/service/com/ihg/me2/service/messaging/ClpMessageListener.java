...
package com.ihg.me2.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			EmailAttachmentLocalServiceUtil.clearService();

			EmailAttachmentServiceUtil.clearService();
			EmailReminderLocalServiceUtil.clearService();

			EmailReminderServiceUtil.clearService();
		}
	}
}