...
/**
 * Provides the remote service interface for EmailAttachment. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author vishal.rangras
 * @see EmailAttachmentServiceUtil
...
public interface EmailAttachmentService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmailAttachmentServiceUtil} to access the email attachment remote service. Add custom service methods to {@link com.ihg.me2.service.impl.EmailAttachmentServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
