...
/**
 * Provides the remote service interface for EmailReminder. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author vishal.rangras
 * @see EmailReminderServiceUtil
...
public interface EmailReminderService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmailReminderServiceUtil} to access the email reminder remote service. Add custom service methods to {@link com.ihg.me2.service.impl.EmailReminderServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
