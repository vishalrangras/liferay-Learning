...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	...
	@Override
	public int compareTo(com.encephalsparks.guestbook.model.Entry entry) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.encephalsparks.guestbook.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public com.encephalsparks.guestbook.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public com.encephalsparks.guestbook.model.Entry toUnescapedModel() {
